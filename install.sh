...
create_user_and_dirs() {
    ...
    mkdir -p "$BLUESTREAM_ETC_DIR" "$BLUESTREAM_RELAY_CONF_DIR" "$BLUESTREAM_PLAYLIST_CONF_DIR"
    chown root:root "$BLUESTREAM_ETC_DIR" "$BLUESTREAM_RELAY_CONF_DIR" "$BLUESTREAM_PLAYLIST_CONF_DIR"
